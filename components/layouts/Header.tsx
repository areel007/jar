        ...
        <>
            ...
            <header className={`fixed w-full top-0 left-0 z-50 py-[23px] transition-bg duration-[.5s] ${scrollPosition > 100 ? 'bg-[#070a10]' : 'bg-transparent'}`}>
                <div className="w-[90%] max-w-[1810px] h-full mx-auto flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-[40px]">
                        ...
                        <Button text="register" className="bg-orange-500 text-white uppercase text-[14px] font-[500] hidden md:block hover:bg-orange-600" onClick={() => { window.location.href = "https://form.veridianarc.com/eoi" }} />
                    </div>
                </div>
            </header>
            ...
            <div className={`fixed top-0 left-0 w-full h-[auto] bg-[#070a17] p-[20px] z-[10] transition-transform duration-[.3s] ${isMobileMenuOpen ? 'translate-y-0' : 'translate-y-[-100%]'}`}>
                ...
                <div className="pt-[10px] mt-[20px] border-t border-t-white/30 flex items-center gap-[5px]">
                    ...
                    <a href="https://linkedin.com/company/swapgov" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" className="fill-white/70 w-[24px]" viewBox="0 0 640 640"><path d="M196.3 512L103.4 512L103.4 212.9L196.3 212.9L196.3 512zM149.8 172.1C120.1 172.1 96 147.5 96 117.8C96 103.5 101.7 89.9 111.8 79.8C121.9 69.7 135.6 64 149.8 64C164 64 177.7 69.7 187.8 79.8C197.9 89.9 203.6 103.6 203.6 117.8C203.6 147.5 179.5 172.1 149.8 172.1zM543.9 512L451.2 512L451.2 366.4C451.2 331.7 450.5 287.2 402.9 287.2C354.6 287.2 347.2 324.9 347.2 363.9L347.2 512L254.4 512L254.4 212.9L343.5 212.9L343.5 253.7L344.8 253.7C357.2 230.2 387.5 205.4 432.7 205.4C526.7 205.4 544 267.3 544 347.7L544 512L543.9 512z" /></svg>
                    </a>
                </div>
            </div>
            ...
            <div className={`fixed right-0 top-0 h-[100vh] w-[400px] bg-white p-[40px] z-[51] transition-transform duration-[.3s] flex flex-col justify-center ${showDesktopSocials ? "translate-x-0" : "translate-x-[100%]"}`}>
                ...
                <div className="flex flex-col gap-[20px]">
                    <a href="http://x.com/swapgov" className="flex items-center gap-[10px]">
                    ...
                    <a href="https://facebook.com/swapgov" className="flex items-center gap-[10px]">
                    ...
                    <a href="https://instagram.com/swapgov" className="flex items-center gap-[10px]">
                    ...
                    <a href="https://linkedin.com/company/swapgov" className="flex items-center gap-[10px]">
                        <svg xmlns="http://www.w3.org/2000/svg" className="fill-black w-[24px]" viewBox="0 0 640 640"><path d="M196.3 512L103.4 512L103.4 212.9L196.3 212.9L196.3 512zM149.8 172.1C120.1 172.1 96 147.5 96 117.8C96 103.5 101.7 89.9 111.8 79.8C121.9 69.7 135.6 64 149.8 64C164 64 177.7 69.7 187.8 79.8C197.9 89.9 203.6 103.6 203.6 117.8C203.6 147.5 179.5 172.1 149.8 172.1zM543.9 512L451.2 512L451.2 366.4C451.2 331.7 450.5 287.2 402.9 287.2C354.6 287.2 347.2 324.9 347.2 363.9L347.2 512L254.4 512L254.4 212.9L343.5 212.9L343.5 253.7L344.8 253.7C357.2 230.2 387.5 205.4 432.7 205.4C526.7 205.4 544 267.3 544 347.7L544 512L543.9 512z" /></svg>
                        <span>LinkedIn</span>
                    </a>
                </div>
            </div>
